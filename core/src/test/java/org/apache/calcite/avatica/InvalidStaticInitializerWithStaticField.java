...
/**
 * A class with an invalid initializer and static field. Certain reflection utils,
 * can create instances by accessing fields with a specified name.
 */
@SuppressWarnings("unused")
public class InvalidStaticInitializerWithStaticField extends InvalidStaticInitializer {
